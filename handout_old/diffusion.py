...
class Diffusion(nn.Module):
    def __init__(
        ...
        *,
        ...
        self.alphas = torch.clip(alpha_bar[1:] / alpha_bar_t_minus_1, 0.001, 1)
    ...
    def p_sample(self, x, t, t_index):
        ...
        posterior_mean = (1 / torch.sqrt(alpha_t)) * (x - (beta_t / torch.sqrt(1 - alpha_bar_t)) * predicted_noise)
    ...
    def p_sample_loop(self, img):
        ...
        for i in range(self.num_timesteps - 1, -1, -1):
            img = self.p_sample(img, torch.full((b,), i, device=img.device), i)
    ...
    def q_sample(self, x_0, t, noise):
        ...
        x_t = extract(self.alpha_bar, t, x_0.shape) * x_0 + extract(torch.sqrt(1 - self.alpha_bar), t, x_0.shape) * noise
        return x_t
    ...
    def p_losses(self, x_0, t, noise):
        ...
        loss = F.l1_loss(self.model(x_t, t), noise)
